...
public class Configuracao extends Form implements CommandListener {
	...
	private Configuracao(String title) {
		...
		cgSync = new ChoiceGroup("Sincroniza��o Autom�tica",
		...
		cgMultimedia = new ChoiceGroup("Conte�do Multim�dia",
				ChoiceGroup.EXCLUSIVE);
		...
		tfMaxTimeExecution = new TextField("Tempo M�ximo (segundos) ", null, 2,
				TextField.NUMERIC);
	...
	public static Configuracao getInstance() {
		if (instance == null) {
			instance = new Configuracao("Configura��o");
		}
		return instance;
	}
	...
	private void saveConfigs() {
		...
		Alerta.getInstance().setTitle("Configura��es");
		Alerta.getInstance().setTexto("Configura��es Salvas com sucesso");
